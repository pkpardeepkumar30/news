...
7. Assign the best-fit category from the story's substance, not its source, location, a source hint or a prior example. Use the broad taxonomy in the schema. Do not manufacture stories merely to fill a category.
...
16. Across the complete supplied collection, aim for 60–100 stories when the evidence supports them and never return more than 100. Review every supplied part before final selection. Preserve geographic and subject diversity without using fixed incident or regional quotas.
